...
const NavBar = () => {
  ...
  return (
    <header className='z-10 w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative lg:px-16 md:px-12 sm:px-8'>
        ...
        {/* mobile navbar */}
        {
            isOpen ?
                    ...
                    className='min-w-[70vw] flex flex-col z-30 justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 dark:bg-light/75 bg-dark/75 text-light dark:text-dark rounded-lg backdrop-blur-md py-32'>
                    ...
                    <nav className='flex items-center justify-center flex-wrap mt-2'>
                        ...
                        <motion.a href="https://github.com/bsen-alt" target={"_blank"}
                        whileHover={{y:-2}}
                        whileTap={{scale:0.9}}
                        className='w-6 mx-3 sm:mx-1'
                        >
                        ...
                        <motion.a href="https://www.linkedin.com/in/bawanga-senevirathne-675564201/" target={"_blank"}
                        whileHover={{y:-2}}
                        whileTap={{scale:0.9}}
                        className='w-6 mx-3 sm:mx-1'
                        >
