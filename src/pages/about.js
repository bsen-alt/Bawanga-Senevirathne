            ...
            <Layout className='pt-16'>
                ...
                <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                    <div className='col-span-4 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'>
                        ...
                        <p className='my-4 font-medium'>Ready to join forces on some tech wizardry? Let&apos;s connect and cook up some groundbreaking projects together. Shoot me a message, and let&apos;s geek out! 😎🚀
                        </p>
